...
then use the extendec Euclidean algorithm to show there exists $h(x),m(x)\in \Q[x]$ 
...
vector space over the field of cardinality $7$).  \hint{If a nonzero group is {\em divisible} then it 
can't be finitely generated.}
